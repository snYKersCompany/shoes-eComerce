      ...
      <Offcanvas show={show} onHide={handleClose} {...props}>
        ...
        <Offcanvas.Body className="d-flex">
          <div className="d-flex flex-column">
            <div className="d-flex flex-column">
              <div className="d-flex align-items-start flex-column containerGenSpanHamb">
                <Link to={"/"} className="text-decoration-none containerIndvSpanHamb">
                ...
                <Link to={"/home"} className="text-decoration-none containerIndvSpanHamb">
                  <span className="d-flex align-items-center text-black fs-3 ">
                ...
                <Link to={"/basketball"} className="text-decoration-none containerIndvSpanHamb">
                  <span className="d-flex align-items-center text-black fs-3 ">
                ...
                <Link to={"/women"} className="text-decoration-none containerIndvSpanHamb">
                  <span className="d-flex align-items-center text-black fs-3 ">
