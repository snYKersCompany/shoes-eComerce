...
function MiddleViewCard() {
    const product = {
        ...
        "name": "Air Jordan",
        "brand": "Nike",
        "card_picture": "https://image.goat.com/375/attachments/product_template_pictures/images/011/119/994/original/218099_00.png.png",
        "price": 53,
        "has_stock": 3,
        range: 10.5,
      }
        ...
        style={{ width: "auto", padding:"0"}}>
            <Row style={{width: "65em"}}>
                ...
                <Col md="auto" className='d-flex obj2'>
                    <p>...Nro... productos en tu carrito: <b>${product.price} * Nro</b></p>
