...
import { deleteProducts, getAllProducts } from '../../../redux/features/products/productsActions';
...
return(
    ...
    >
      <Modal.Header className="header d-flex">
        <Modal.Title id="contained-modal-title-vcenter" className="d-flex justify-content-center w-100">
            <h3>Are you sure?</h3>
        </Modal.Title>
      </Modal.Header>
      ...
      <Modal.Body className="d-flex">
        <Button className="bg-success me-5" onClick={() => props.onHide()}>Cancel</Button>
        <Button className="bg-danger" onClick={() => handlerOnClick()}>Delete</Button>
      </Modal.Body>
        </div>
