  ...
  return trolley && trolley.purchase_state === "done" ? (
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <PaymentForm
            userName={trolley.userName}
            transactionId={trolley.transactionId}
            moneyWasted={trolley.moneyWasted}
            brand={trolley.brand}
            purchase_state={trolley.purchase_state}
          />
        </Modal.Body>
        <Modal.Footer>
          <Link to="/home">
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>Your purchase was denied, try again please</Modal.Body>
        <Modal.Footer>
          <Link to="/home">
            <Button variant="primary" onClick={handleClose}>
              back to home
